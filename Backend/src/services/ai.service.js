...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
  ...
  const prompt = `Generate resume PDF for a candidate with the following details:
                      ...
                      the response should be a valid JSON matching the following schema.
                      the resume generated should not sound like it's generated by ai and should be as close as possible to a real human-written resume.
`;
  const response = await ai.models.generateContent({
    model: process.env.GEMINI_MODEL,
    contents: prompt,
